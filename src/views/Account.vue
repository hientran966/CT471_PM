<template>
<div class="row" style="display: flex; justify-content: center; align-items: center; width: calc(100vw - 50px); height: 200px; background-color: lightgray; position: relative;">
